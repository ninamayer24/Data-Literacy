...
This directory contains the data that is used throughout the project. We included three different datasets in our analysis, namely: 
- [Bridges in Germany](https://opendata-esridech.hub.arcgis.com/datasets/da031936bbaa4aad8302b3bcbf9494b5_0/explore?location=51.010145%2C10.441931%2C6.69&showTable=true)
...
`final_bridge_statistic_germany.csv`: final dataset used in our analysis

`gdp_dataset.xlsx`: original GDP dataset

`gdp_dataset_cleaned.csv`: preprocessed GDP dataset

`original_bridge_statistic_germany.csv`: original bridge dataset
